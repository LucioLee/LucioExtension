...
extension UIImage {
    func rotate(orientation orientation: UIImageRotateOrientation) -> UIImage {
        var transform = CGAffineTransformIdentity
        switch orientation {
        case .Mirrored :
...
image.rotate(orientation: .Mirrored)
image.rotate(orientation: .Left)
image.rotate(orientation: .LeftMirrored)
image.rotate(orientation: .Down)
image.rotate(orientation: .DownMirrored)
image.rotate(orientation: .Right)
image.rotate(orientation: .RightMirrored)
